...
public class TelegramBotInlineMenus {
    ...
    public static final String MENU_ORDER_QUANTITY_TEXT = "Подтвердить";
    ...
    public static final String CALLBACK_ORDER_QUANTITY_HEADER = "CallbackOrderQuantity";
     ...
     */
    public TelegramBotInlineMenu createQuantityButton(String productId){
        return createButton(MENU_ORDER_QUANTITY_TEXT, CALLBACK_ORDER_QUANTITY_HEADER, productId);
    }
